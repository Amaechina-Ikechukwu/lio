  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      <div className="max-w-lg p-4 bg-white rounded-lg shadow-lg">
        ...
        <p>
          Welcome to [Your Web App Name] ("the Web App"). By using or accessing
          the Web App in any way, you agree to comply with and be bound by these
        ...
        <p>
          ...
          at any time without notice. Your continued use of the Web App
        ...
        <p>
          Your use of the Web App is also governed by our Privacy Policy, which
          can be found [link to Privacy Policy]. Please review our Privacy
          Policy to understand how we collect, use, and protect your personal
          information.
        </p>

        <h2 className="text-xl font-semibold mt-4 mb-2">4. User Registration</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">5. Content and User Conduct</h2>
        <p>
